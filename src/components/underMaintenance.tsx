export default function UnderMaintenance() {
  return (
    <section className="bg-white dark:bg-boxdark dark:text-white">
      <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">
          Our Enterprise Developers & administrators are performing scheduled
          maintenance.
        </p>
      </div>
    </section>
  ...
  return (
    <section className="bg-white dark:bg-boxdark dark:text-white">
      <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">
          Worry Not This Feature Coming Soon. Our Developers & administrators
          are on work.
        </p>
      </div>
    </section>
