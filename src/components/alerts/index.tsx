  ...
  return (
    ...
    >
      <div className="flex items-center">
        ...
        <span className="sr-only">Info</span>
        <h3 className="text-lg font-medium">{alertText}</h3>
      </div>
      <div className="mt-2 mb-4 text-sm">{moreAlertInfo}</div>
      <div className="flex">
        {/* <button
          type="button"
          className="text-red-800 bg-hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
        >
          <svg
            className="me-2 h-3 w-3"
            aria-hidden="true"
...
export function AlertSuccess({
  alertText = 'Submission was Successful',
  moreAlertInfo = 'A member of our team should contact you soon'
}) {
  return (
    <div
